...
import type { ConfirmUploadPath, DeleteContentPath, DeleteUserPath, DeleteWidgetPath, DownloadContentPath, GetContentMetadataPath, GetContentPath, GetProfilePath, GetUserPath, GetUserProfilePath, GetWidgetPath, ListContentObjectsPath, PreviewContentPath, PutProfilePath, ResetUserPasswordPath, SetContentMetadataPath, SetUserAvatarPath, SetUserProfilePath, SetUserRolesPath, UpdateContentPath, UpdateUserPath, UpdateWidgetPath } from "./api-types";
// Admin
...
export function setUserRoles(params: SetUserRolesPath): string {
    return `admin/users/${params.id}/roles`;
}
