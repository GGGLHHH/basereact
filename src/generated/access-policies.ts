...
export const accessPolicies = {
  listAuthEvents: {
    apiPath: "/api/v1/admin/auth/auth-events",
    kind: "permission",
    method: "GET",
    operationId: "list_auth_events",
    path: "admin/auth/auth-events",
    permissions: ["users:admin", "admin:login"],
  },
  statsAuthEvents: {
    apiPath: "/api/v1/admin/auth/auth-events/stats",
    kind: "permission",
    method: "GET",
    operationId: "stats_auth_events",
    path: "admin/auth/auth-events/stats",
    permissions: ["users:admin", "admin:login"],
  },
  streamAuthEvents: {
    apiPath: "/api/v1/admin/auth/auth-events/stream",
    kind: "permission",
    method: "GET",
    operationId: "stream_auth_events",
    path: "admin/auth/auth-events/stream",
    permissions: ["users:admin", "admin:login"],
  },
  adminGetMe: {
  ...
  listRoles: {
    apiPath: "/api/v1/admin/auth/roles",
    kind: "permission",
    method: "GET",
  ...
  listTenants: {
    apiPath: "/api/v1/admin/auth/tenants",
    kind: "permission",
    method: "GET",
    operationId: "list_tenants",
    path: "admin/auth/tenants",
    permissions: ["tenants:admin", "admin:login"],
  },
  createTenant: {
    apiPath: "/api/v1/admin/auth/tenants",
    kind: "permission",
  ...
  updateTenant: {
    apiPath: "/api/v1/admin/auth/tenants/{id}",
    kind: "permission",
    method: "PUT",
    operationId: "update_tenant",
    path: "admin/auth/tenants/{id}",
    permissions: ["tenants:admin", "admin:login"],
  },
  listUsers: {
    apiPath: "/api/v1/admin/auth/users",
    kind: "permission",
    method: "GET",
  ...
  getUser: {
    apiPath: "/api/v1/admin/auth/users/{id}",
    kind: "permission",
    method: "GET",
  ...
  listUserAuthEvents: {
    apiPath: "/api/v1/admin/auth/users/{id}/auth-events",
    kind: "permission",
    method: "GET",
    operationId: "list_user_auth_events",
    path: "admin/auth/users/{id}/auth-events",
    permissions: ["users:admin", "admin:login"],
  },
  setUserAvatar: {
    apiPath: "/api/v1/admin/auth/users/{id}/avatar",
    kind: "permission",
    method: "POST",
    operationId: "set_user_avatar",
    path: "admin/auth/users/{id}/avatar",
    permissions: ["users:admin", "admin:login"],
  },
  resetUserPassword: {
    apiPath: "/api/v1/admin/auth/users/{id}/password",
    kind: "permission",
    method: "POST",
  ...
  getUserProfile: {
    apiPath: "/api/v1/admin/auth/users/{id}/profile",
    kind: "permission",
    method: "GET",
    operationId: "get_user_profile",
    path: "admin/auth/users/{id}/profile",
    permissions: ["users:admin", "admin:login"],
  },
  setUserProfile: {
    apiPath: "/api/v1/admin/auth/users/{id}/profile",
  ...
  setUserRoles: {
    apiPath: "/api/v1/admin/auth/users/{id}/roles",
    kind: "permission",
    method: "PUT",
    operationId: "set_user_roles",
    path: "admin/auth/users/{id}/roles",
    permissions: ["users:admin", "admin:login"],
  },
  adminListWidgets: {
  ...
  listMembers: {
    apiPath: "/api/v1/frontend/auth/tenants/members",
    kind: "authenticated",
    method: "GET",
    operationId: "list_members",
    path: "frontend/auth/tenants/members",
  },
  addMember: {
    apiPath: "/api/v1/frontend/auth/tenants/members",
    kind: "authenticated",
  ...
  removeMember: {
    apiPath: "/api/v1/frontend/auth/tenants/members/{user_id}",
    kind: "authenticated",
    method: "DELETE",
    operationId: "remove_member",
    path: "frontend/auth/tenants/members/{user_id}",
  },
  listContents: {
